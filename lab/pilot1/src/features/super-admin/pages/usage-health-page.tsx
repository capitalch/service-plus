...
import type { MetricTrendType, ServiceHealthStatusType } from "../types";
    ...
    <SuperAdminLayout>
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-lg font-semibold text-slate-900">Usage & Health</h1>
            <p className="text-sm text-slate-500">Monitor platform metrics and service health in real time.</p>
          </div>
          <Badge
            className={
              overallHealthy
                ...
                <Card className="border shadow-sm">
                  <CardContent className="p-4">
                    <div className="mb-1 flex items-center justify-between">
                      ...
                      <ActivityIcon className="h-3.5 w-3.5 text-slate-300" />
                    </div>
        ...
        {/* Bottom row: chart + service health */}
              ...
              <CardContent className="p-6">
                ...
                <ResponsiveContainer height={200} width="100%">
                  <AreaChart data={dummyUptimeData} margin={{ bottom: 0, left: 0, right: 8, top: 4 }}>
                    <defs>
                      <linearGradient id="uptimeGrad" x1="0" x2="0" y1="0" y2="1">
                  ...
                  {dummySystemServices.map((svc) => (
                    <div className="flex items-center justify-between" key={svc.id}>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <Badge className={statusBadge[svc.status]} variant="outline">
                          {svc.status}
                        </Badge>
                      </div>
                    </div>
