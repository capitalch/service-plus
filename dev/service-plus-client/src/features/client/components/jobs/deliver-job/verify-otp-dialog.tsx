			...
			<DialogContent aria-describedby={undefined} className="sm:max-w-sm">
				...
				<div className="py-2 space-y-3">
					<p className="text-sm text-(--cl-text)">
						Ask the customer to read out the 4-digit code from the WhatsApp message, and enter it below.
					</p>
					<Input
						autoFocus
						inputMode="numeric"
						...
						onKeyDown={(e) => {
							if (e.key === "Enter" && code.length === 4) void handleVerify();
						}}
					/>
				...
				<DialogFooter className="sm:justify-between">
					...
					<div className="flex gap-2">
						...
						<Button disabled={code.length !== 4 || verifying} onClick={() => void handleVerify()}>
							{verifying ? (
