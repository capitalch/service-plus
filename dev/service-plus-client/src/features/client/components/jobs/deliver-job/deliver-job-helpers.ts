...
export const PAYMENT_MODES = ["Cash", "Card", "UPI", "Cheque", "Online Transfer", "Other"] as const;
...
export const tdClass = "px-2 py-1.5 text-sm text-(--cl-text) border-b border-(--cl-border)";
