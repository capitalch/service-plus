		...
		return (
			<div className="flex items-center justify-center rounded-lg border border-(--cl-border) bg-(--cl-surface-2) p-20">
				<div className="text-center">
					...
					<p className="mt-2 text-xs text-(--cl-text-muted)">Select a branch to manage its divisions.</p>
				</div>
			</div>
		);
	}
									...
									{displayDivisions.length === 0 ? (
										...
										displayDivisions.map((division, idx) => (
											...
											>
												...
												<TableCell className="font-mono text-xs font-semibold text-(--cl-text)">
													{division.code}
												</TableCell>
												...
												<TableCell>
													{division.gstin ? (
														<span className="font-mono text-xs text-(--cl-text)">
															{division.gstin}
														</span>
													) : (
												...
												<TableCell>
													...
													>
														<span
															className={`mr-1 h-1.5 w-1.5 rounded-full ${division.is_active ? "bg-emerald-500" : "bg-slate-400"}`}
														/>
