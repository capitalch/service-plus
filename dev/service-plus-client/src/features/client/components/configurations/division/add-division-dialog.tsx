...
export const AddDivisionDialog = ({ onOpenChange, onSuccess, open }: AddDivisionDialogPropsType) => {
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			>
				<DialogHeader className="shrink-0">
					<DialogTitle className="text-base font-semibold text-foreground">Add Division</DialogTitle>
				</DialogHeader>
								...
								<div className="flex flex-col gap-4 pt-1 overflow-y-auto min-h-0 flex-1 pr-1">
									...
									<div className="rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3 shadow-sm">
										...
										<div className="mt-3 grid grid-cols-2 gap-3">
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_r_debit" className="text-xs">
													Debit A/c ID
												</Label>
												<Input
													autoComplete="off"
											...
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_r_credit" className="text-xs">
													Credit A/c ID
												</Label>
												<Input
													autoComplete="off"
									...
									<div className="rounded-lg border border-violet-200 bg-violet-50 px-4 py-3 shadow-sm">
										...
										<div className="mt-3 grid grid-cols-2 gap-3">
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_pi_debit" className="text-xs">
													Debit A/c ID
												</Label>
												<Input
													autoComplete="off"
											...
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_pi_credit" className="text-xs">
													Credit A/c ID
												</Label>
												<Input
													autoComplete="off"
										...
										<div className="mt-3 grid grid-cols-3 gap-3">
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_pi_prod" className="text-xs">
													Product Id
												</Label>
												<Input
													autoComplete="off"
											...
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_pi_hsn" className="text-xs">
													Default HSN
												</Label>
												<Input
													autoComplete="off"
											...
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_pi_gst" className="text-xs">
													Default GST Rate %
												</Label>
												<Input
													autoComplete="off"
									...
									<div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 shadow-sm">
										...
										<div className="mt-3 grid grid-cols-2 gap-3">
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_si_debit" className="text-xs">
													Debit A/c ID
												</Label>
												<Input
													autoComplete="off"
											...
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_si_credit" className="text-xs">
													Credit A/c ID
												</Label>
												<Input
													autoComplete="off"
										...
										<div className="mt-3 grid grid-cols-3 gap-3">
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_si_prod" className="text-xs">
													Product Id
												</Label>
												<Input
													autoComplete="off"
											...
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_si_hsn" className="text-xs">
													Default HSN
												</Label>
												<Input
													autoComplete="off"
											...
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_si_gst" className="text-xs">
													Default GST Rate %
												</Label>
												<Input
													autoComplete="off"
										...
										<div className="mt-3 grid grid-cols-3 gap-3">
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_si_contacts" className="text-xs">
													Contacts ID
												</Label>
												<Input
													autoComplete="off"
									...
									<div className="rounded-lg border border-teal-200 bg-teal-50 px-4 py-3 shadow-sm">
										...
										<div className="mt-3 grid grid-cols-2 gap-3">
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_ji_debit" className="text-xs">
													Debit A/c ID
												</Label>
												<Input
													autoComplete="off"
											...
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_ji_credit" className="text-xs">
													Credit A/c ID
												</Label>
												<Input
													autoComplete="off"
										...
										<div className="mt-3 grid grid-cols-3 gap-3">
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_ji_prod" className="text-xs">
													Product Id
												</Label>
												<Input
													autoComplete="off"
											...
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_ji_hsn" className="text-xs">
													Default HSN
												</Label>
												<Input
													autoComplete="off"
											...
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_ji_gst" className="text-xs">
													Default GST Rate %
												</Label>
												<Input
													autoComplete="off"
										...
										<div className="mt-3 grid grid-cols-3 gap-3">
											<div className="flex flex-col gap-1.5">
												<Label htmlFor="dv_ji_contacts" className="text-xs">
													Contacts ID
												</Label>
												<Input
													autoComplete="off"
