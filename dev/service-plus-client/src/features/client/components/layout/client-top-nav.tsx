...
const NAV_ITEMS: NavItem[] = [
	...
	{ label: "Masters", section: "masters", to: ROUTES.client.masters, requiredRight: ACCESS_RIGHTS.MASTERS_MENU },
	{
		...
		requiredRight: ACCESS_RIGHTS.CONFIG_MENU,
	},
	...
	return (
		<header className="fixed left-0 right-0 top-0 z-50 flex h-12 items-center overflow-x-auto border-b border-(--cl-border) bg-(--cl-bg) px-3 sm:px-4">
			...
			<div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3 lg:gap-4 overflow-hidden">
				...
				<span className="shrink-0 text-lg font-black tracking-tighter text-(--cl-accent-text) hidden xs:block">
					Service+
				</span>
			...
			<div className="flex shrink-0 items-center justify-end gap-1 sm:gap-3">
				...
				<NotificationBell className="hidden hover:bg-(--cl-hover) sm:flex" items={notificationItems} />
