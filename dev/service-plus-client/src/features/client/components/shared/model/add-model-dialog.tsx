...
export const AddModelDialog = ({ brands, onOpenChange, onSuccess, open, products }: AddModelDialogPropsType) => {
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			>
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Add Model</DialogTitle>
				</DialogHeader>
