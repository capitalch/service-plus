...
import { AddModelDialog } from "@/features/client/components/add-model-dialog";
import { DeleteModelDialog } from "@/features/client/components/delete-model-dialog";
import { EditModelDialog } from "@/features/client/components/edit-model-dialog";
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-[var(--cl-surface-3)] hover:bg-[var(--cl-surface-3)]">
                                        ...
                                        <TableHead className="text-xs font-semibold uppercase tracking-wide text-[var(--cl-text-muted)]">Product</TableHead>
                                        <TableHead className="text-xs font-semibold uppercase tracking-wide text-[var(--cl-text-muted)]">Brand</TableHead>
                                        <TableHead className="text-xs font-semibold uppercase tracking-wide text-[var(--cl-text-muted)]">Model Name</TableHead>
