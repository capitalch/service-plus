...
import type {
	CategoryBucketFieldType,
	CategoryBucketRangeType,
	CategoryRangeRowType,
	CategorySplitType,
} from "../common/use-category-range-matrix";
...
export const useJobsCombinedMatrix = (): JobsCombinedMatrixType => {
	...
	const repaired = useCategoryRangeMatrix(
		SQL_MAP.GET_JOBS_REPAIRED_OK_BY_CATEGORY_RANGE_SPLIT,
		fyStartMonth,
		isReady,
	);
	const delivered = useCategoryRangeMatrix(
		SQL_MAP.GET_JOBS_DELIVERED_OK_BY_CATEGORY_RANGE_SPLIT,
		fyStartMonth,
		isReady,
	);
