...
const COLUMNS: ReportColumnType<RowType>[] = [
	...
	{
		align: "right",
		cell: (r) => formatNumber(Number(r.opening_qty)),
		header: "Op Qty",
		id: "oq",
		value: (r) => Number(r.opening_qty),
		width: "80px",
	},
	{
		align: "right",
		cell: (r) => formatInr(Number(r.opening_value)),
		header: "Op ₹",
		id: "ov",
		value: (r) => Number(r.opening_value),
		width: "100px",
	},
	{
		align: "right",
		cell: (r) => formatNumber(Number(r.dr_qty)),
		header: "Dr Qty",
		id: "dq",
		value: (r) => Number(r.dr_qty),
		width: "80px",
	},
	{
		align: "right",
		cell: (r) => formatInr(Number(r.dr_value)),
		header: "Dr ₹",
		id: "dv",
		value: (r) => Number(r.dr_value),
		width: "100px",
	},
	{
		align: "right",
		cell: (r) => formatNumber(Number(r.cr_qty)),
		header: "Cr Qty",
		id: "cq",
		value: (r) => Number(r.cr_qty),
		width: "80px",
	},
	{
		align: "right",
		cell: (r) => formatInr(Number(r.cr_value)),
		header: "Cr ₹",
		id: "cv",
		value: (r) => Number(r.cr_value),
		width: "100px",
	},
	{
		align: "right",
		cell: (r) => <span className="font-bold">{formatNumber(Number(r.closing_qty))}</span>,
		header: "Cl Qty",
		id: "clq",
		value: (r) => Number(r.closing_qty),
		width: "90px",
	},
	{
		align: "right",
		cell: (r) => <span className="font-bold text-emerald-600">{formatInr(Number(r.closing_value))}</span>,
		footer: (rs) => formatInr(rs.reduce((s, r) => s + Number(r.closing_value), 0)),
		header: "Cl ₹",
		id: "clv",
		value: (r) => Number(r.closing_value),
		width: "120px",
	},
];
...
export const SparePartsLedgerSection = () => {
	...
	useEffect(() => {
		...
		let cancelled = false;
		apolloClient
			.query<{ genericQuery: FinancialYearType[] | null }>({
		...
		<ReportSection>
			...
			>
				<div className="flex flex-col gap-1">
					...
					<Select onValueChange={(v) => setFyId(Number(v))} value={fyId != null ? String(fyId) : ""}>
