	...
	return (
		<div className={cn("flex flex-wrap items-end gap-2", className)}>
			<div className="flex flex-col gap-1">
				<Label className="text-[10px] font-bold uppercase tracking-wider text-(--cl-text-muted)">Range</Label>
			...
			{customOpen && (
				<div className="flex flex-wrap items-end gap-2">
					<div className="flex flex-col gap-1">
						<Label
							htmlFor="range-from"
							className="text-[10px] font-bold uppercase tracking-wider text-(--cl-text-muted)"
						>
							From
						</Label>
						<Input
			...
			{error && <p className="basis-full text-xs font-medium text-red-600">{error}</p>}
		</div>
	);
};
