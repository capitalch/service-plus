...
const COLUMNS: ReportColumnType<RowType>[] = [
	{
		cell: (r) => formatDateShort(r.invoice_date),
		header: "Date",
		id: "date",
	...
	{
		cell: (r) => <span className="font-mono text-(--cl-accent-text)">{r.invoice_no}</span>,
		header: "Invoice",
		id: "inv",
	...
	{
		align: "right",
		footer: (rs) => formatNumber(rs.reduce((s, r) => s + Number(r.qty), 0)),
		header: "Qty",
		id: "qty",
	...
	{
		align: "right",
		cell: (r) => formatInr(Number(r.price)),
		header: "Price",
		id: "price",
	...
	},
	{
		...
		footer: (rs) => formatInr(rs.reduce((s, r) => s + Number(r.amount), 0)),
		header: "Amount",
		id: "amt",
	...
	{
		align: "right",
		cell: (r) => formatInr(Number(r.gst_amount)),
		footer: (rs) => formatInr(rs.reduce((s, r) => s + Number(r.gst_amount), 0)),
		header: "GST",
		id: "gst",
		value: (r) => Number(r.gst_amount),
		width: "100px",
	},
];
