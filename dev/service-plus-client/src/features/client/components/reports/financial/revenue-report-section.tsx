		...
		<ReportSection>
			...
			<KpiGrid columns={4}>
				...
				<KpiCard
					label="Job Invoices"
					loading={summaryQ.loading}
					value={formatInr(Number(summary?.job_invoice_total ?? 0))}
					subValue={`${summary?.job_invoice_count ?? 0} invoices`}
				/>
				<KpiCard
					label="Sales Invoices"
					loading={summaryQ.loading}
					value={formatInr(Number(summary?.sales_invoice_total ?? 0))}
					subValue={`${summary?.sales_invoice_count ?? 0} invoices`}
				/>
				<KpiCard
					label="Total GST"
					loading={summaryQ.loading}
					value={formatInr(Number(summary?.gst_total ?? 0))}
				/>
			</KpiGrid>
