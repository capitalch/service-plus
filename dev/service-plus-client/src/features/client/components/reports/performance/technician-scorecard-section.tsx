...
const COLUMNS: ReportColumnType<RowType>[] = [
	...
	{
		align: "right",
		cell: (r) => formatNumber(Number(r.received_count)),
		footer: (rs) => formatNumber(rs.reduce((s, r) => s + Number(r.received_count), 0)),
		header: "Received",
		id: "rec",
	...
	{
		align: "right",
		cell: (r) => formatNumber(Number(r.repaired_count)),
		footer: (rs) => formatNumber(rs.reduce((s, r) => s + Number(r.repaired_count), 0)),
		header: "Repaired",
		id: "rep",
		value: (r) => Number(r.repaired_count),
	},
	{
		align: "right",
		cell: (r) => formatNumber(Number(r.delivered_count)),
		footer: (rs) => formatNumber(rs.reduce((s, r) => s + Number(r.delivered_count), 0)),
		header: "Delivered",
		id: "del",
		value: (r) => Number(r.delivered_count),
	},
	{
		align: "right",
		cell: (r) => `${Number(r.avg_turnaround_days).toFixed(1)} d`,
		header: "Avg Turnaround",
		id: "tat",
		value: (r) => Number(r.avg_turnaround_days),
	},
	{
		align: "right",
		cell: (r) => formatInr(Number(r.revenue)),
		footer: (rs) => formatInr(rs.reduce((s, r) => s + Number(r.revenue), 0)),
		header: "Revenue",
		id: "rev",
	...
	{
		align: "right",
		cell: (r) => <span className="font-bold text-emerald-600">{formatInr(Number(r.profit))}</span>,
		footer: (rs) => formatInr(rs.reduce((s, r) => s + Number(r.profit), 0)),
		header: "Profit",
		id: "p",
