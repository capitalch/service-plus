                                    ...
                                    {displayModels.length === 0 ? (
                                        ...
                                        displayModels.map((model, idx) => (
                                            ...
                                            >
                                                ...
                                                <TableCell className="font-mono text-sm font-medium text-(--cl-text)">{model.product_name ?? "—"}</TableCell>
                                                <TableCell className="font-mono text-sm text-(--cl-text-muted)">{model.brand_name ?? "—"}</TableCell>
                                                <TableCell className="font-medium text-(--cl-text)">{model.model_name}</TableCell>
                                                <TableCell className="text-sm text-(--cl-text-muted)">{model.launch_year ?? "—"}</TableCell>
                                                <TableCell>
                                                    <Badge
                                                        ...
                                                        variant="outline"
                                                    >
                                                        <span className={`mr-1 h-1.5 w-1.5 rounded-full ${model.is_active ? "bg-emerald-500" : "bg-slate-400"}`} />
