		...
		<>
			...
			>
				<div className="flex flex-wrap items-start justify-between gap-3">
					<div>
						<h1 className="text-xl font-bold text-(--cl-text)">Models</h1>
						<p className="mt-1 text-sm text-(--cl-text-muted)">Manage product-brand-model combinations.</p>
					</div>
							...
							<Table>
								<TableHeader>
									<TableRow className="sticky top-0 z-10 bg-(--cl-surface-3) hover:bg-(--cl-surface-3)">
										...
										<TableHead className={thSortClass} onClick={() => handleSort("product_name")}>
											Product
											<SortIcon col="product_name" />
										</TableHead>
										<TableHead className={thSortClass} onClick={() => handleSort("brand_name")}>
											Brand
											<SortIcon col="brand_name" />
										</TableHead>
										<TableHead className={thSortClass} onClick={() => handleSort("model_name")}>
											Model Name
											<SortIcon col="model_name" />
										</TableHead>
										<TableHead className={thSortClass} onClick={() => handleSort("launch_year")}>
											Year
											<SortIcon col="launch_year" />
										</TableHead>
										...
										displayModels.map((model, idx) => (
											...
											>
												...
												<TableCell>
													...
													>
														<span
															className={`mr-1 h-1.5 w-1.5 rounded-full ${model.is_active ? "bg-emerald-500" : "bg-slate-400"}`}
														/>
