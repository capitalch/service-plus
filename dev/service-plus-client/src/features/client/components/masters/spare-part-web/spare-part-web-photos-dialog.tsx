...
import { deleteSparePartWebImage, reorderSparePartWebImages, uploadSparePartWebImages } from "@/lib/image-service";
			...
			>
				...
				{loading ? (
					...
					<EntityImageUpload
						...
						uploadFiles={(files) =>
							uploadSparePartWebImages(dbName!, schema_!, part.id, clientCode, buCode, files)
						}
