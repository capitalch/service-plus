...
export type SparePartWebDialogProps = BaseProps & ({ mode: "add" } | { mode: "edit"; part: SparePartWebType });
...
export const SparePartWebDialog = (props: SparePartWebDialogProps) => {
	...
	async function onSubmit(data: FormType) {
		...
		try {
			...
			toast.error(
				isEdit ? MESSAGES.ERROR_SPARE_PART_WEB_UPDATE_FAILED : MESSAGES.ERROR_SPARE_PART_WEB_CREATE_FAILED,
			);
		} finally {
			setSubmitting(false);
		}
