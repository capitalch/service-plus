...
export const AddPartLocationDialog = ({ onOpenChange, onSuccess, open }: AddPartLocationDialogPropsType) => {
	...
	useEffect(() => {
		...
		if (form.getFieldState("location").invalid) {
			setLocationTaken(null);
			return;
		}
	...
	const submitDisabled =
		checkingLocation || locationTaken === true || Object.keys(errors).length > 0 || form.formState.isSubmitting;

	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent aria-describedby={undefined} className="sm:max-w-md">
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Add Part Location</DialogTitle>
				</DialogHeader>
