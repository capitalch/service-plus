	...
	useEffect(() => {
		...
		apolloClient
			...
			.then((res) => {
				...
				if (exists)
					form.setError("location", { message: MESSAGES.ERROR_PART_LOCATION_EXISTS_EDIT, type: "manual" });
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent aria-describedby={undefined} className="sm:max-w-md">
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Edit Part Location</DialogTitle>
				</DialogHeader>
