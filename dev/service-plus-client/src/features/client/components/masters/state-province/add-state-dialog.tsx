...
export const AddStateDialog = ({ onOpenChange, onSuccess, open }: AddStateDialogPropsType) => {
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent aria-describedby={undefined} className="sm:max-w-sm">
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Add State / Province</DialogTitle>
				</DialogHeader>
