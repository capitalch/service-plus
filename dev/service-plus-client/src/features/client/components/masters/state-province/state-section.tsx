        ...
        <>
            ...
            >
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                        <h1 className="text-xl font-bold text-(--cl-text)">States / Provinces</h1>
                                    ...
                                    {displayStates.length === 0 ? (
                                        ...
                                        displayStates.map((st, idx) => (
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    <span className="font-mono text-xs font-semibold text-(--cl-text)">{st.code}</span>
                                                </TableCell>
                                                <TableCell className="font-medium text-(--cl-text)">{st.name}</TableCell>
                                                <TableCell className="text-sm text-(--cl-text-muted)">{st.country_code}</TableCell>
                                                <TableCell className="text-sm text-(--cl-text-muted)">{st.gst_state_code ?? "—"}</TableCell>
                                                <TableCell>
                                                ...
                                                <TableCell>
                                                    <Badge
                                                        ...
                                                        variant="outline"
                                                    >
                                                        <span className={`mr-1 h-1.5 w-1.5 rounded-full ${st.is_active ? "bg-emerald-500" : "bg-slate-400"}`} />
