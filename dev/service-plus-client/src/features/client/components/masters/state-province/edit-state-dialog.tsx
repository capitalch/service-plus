...
export const EditStateDialog = ({ state, onOpenChange, onSuccess, open }: EditStateDialogPropsType) => {
	...
	useEffect(() => {
		...
		if (debouncedName.toLowerCase() === state.name.toLowerCase()) {
			setNameTaken(false);
			return;
		}
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent aria-describedby={undefined} className="sm:max-w-sm">
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Edit State / Province</DialogTitle>
				</DialogHeader>
