...
const addCustomerSchema = z.object({
	...
	postal_code: z
		.string()
		.refine((v) => !v || POSTAL_CODE_REGEX.test(v), "Enter a valid 6-digit postal code")
		.optional(),
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent
				...
				className="flex max-h-[90vh] flex-col sm:max-w-2xl overflow-y-auto overflow-x-hidden"
				onInteractOutside={(e) => e.preventDefault()}
			>
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Add Customer</DialogTitle>
				</DialogHeader>
				...
				<form className="flex flex-col gap-4" onSubmit={form.handleSubmit(onSubmit)}>
					<div className="grid grid-cols-2 gap-4">
						...
						<div className="flex flex-col gap-1.5">
							...
							<Select
								onValueChange={(v) =>
									form.setValue("customer_type_id", Number(v), { shouldValidate: true })
								}
							>
					...
					<div className="grid grid-cols-3 gap-4">
						...
						<div className="flex flex-col gap-1.5">
							...
							<Input autoComplete="off" id="ac_city" placeholder="City" {...form.register("city")} />
						</div>
