	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent aria-describedby={undefined} className="flex max-h-[90vh] flex-col sm:max-w-2xl">
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Edit Customer</DialogTitle>
				</DialogHeader>

				<form className="flex flex-col gap-4 overflow-y-auto px-1 pt-1" onSubmit={form.handleSubmit(onSubmit)}>
					...
					<div className="grid grid-cols-3 gap-4">
						...
						<div className="flex flex-col gap-1.5">
							...
							<Input autoComplete="off" id="ec_city" placeholder="City" {...form.register("city")} />
						</div>
