		...
		<>
			...
			>
				...
				<div className="flex flex-wrap items-start justify-between gap-3">
					<div>
						<h1 className="text-xl font-bold text-(--cl-text)">Customers</h1>
						<p className="mt-1 text-sm text-(--cl-text-muted)">Manage customers for this business unit.</p>
					</div>
							...
							<Table>
								<TableHeader>
									<TableRow className="sticky top-0 z-10 bg-(--cl-surface-3) hover:bg-(--cl-surface-3)">
										...
										<TableHead className={thSortClass} onClick={() => handleSort("mobile")}>
											Mobile
											<SortIcon col="mobile" />
										</TableHead>
										<TableHead
											className={thSortClass}
											onClick={() => handleSort("customer_type_name")}
										>
											Type
											<SortIcon col="customer_type_name" />
										</TableHead>
									...
									{displayCustomers.length === 0 ? (
										...
										displayCustomers.map((customer, idx) => (
											...
											>
												...
												<TableCell className="font-mono text-sm text-(--cl-text)">
													{customer.mobile}
												</TableCell>
												...
												<TableCell>
													...
													>
														<span
															className={`mr-1 h-1.5 w-1.5 rounded-full ${customer.is_active ? "bg-emerald-500" : "bg-slate-400"}`}
														/>
