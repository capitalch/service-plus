...
export const AddVendorDialog = ({ onOpenChange, onSuccess, open, states }: AddVendorDialogPropsType) => {
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			>
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Add Vendor</DialogTitle>
				</DialogHeader>
				...
				<form className="flex flex-col gap-4 pt-1" onSubmit={form.handleSubmit(onSubmit)}>
					...
					<div className="grid grid-cols-3 gap-4">
						...
						<div className="flex flex-col gap-1.5">
							...
							<Input autoComplete="off" id="av_city" placeholder="City" {...form.register("city")} />
						</div>
