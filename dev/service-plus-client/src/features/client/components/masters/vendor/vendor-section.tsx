...
export const VendorSection = () => {
	...
	return (
		<>
										...
										displayVendors.map((vendor, idx) => (
											...
											>
												...
												<TableCell>
													...
													>
														<span
															className={`mr-1 h-1.5 w-1.5 rounded-full ${vendor.is_active ? "bg-emerald-500" : "bg-slate-400"}`}
														/>
			...
			{/* ── Dialogs ──────────────────────────────────────────────────────── */}
			<AddVendorDialog open={addOpen} states={states} onOpenChange={setAddOpen} onSuccess={loadData} />
			{editVendor && (
				<EditVendorDialog
					open={!!editVendor}
					states={states}
