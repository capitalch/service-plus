		...
		<>
			...
			>
				<div className="flex flex-wrap items-start justify-between gap-3">
					<div>
						<h1 className="text-xl font-bold text-(--cl-text)">Products</h1>
									...
									{displayProducts.length === 0 ? (
										...
										displayProducts.map((product, idx) => (
											...
											>
												...
												<TableCell className="font-mono font-medium text-(--cl-text)">
													{product.name}
												</TableCell>
												<TableCell>
													<Badge
													...
													>
														<span
															className={`mr-1 h-1.5 w-1.5 rounded-full ${product.is_active ? "bg-emerald-500" : "bg-slate-400"}`}
														/>
			...
			<AddProductDialog open={addOpen} onOpenChange={setAddOpen} onSuccess={loadData} />
			{editProduct && (
				<EditProductDialog
					open={!!editProduct}
					product={editProduct}
