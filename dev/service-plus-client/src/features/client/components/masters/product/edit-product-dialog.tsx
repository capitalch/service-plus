...
export const EditProductDialog = ({ onOpenChange, onSuccess, open, product }: EditProductDialogPropsType) => {
	...
	useEffect(() => {
		...
		if (debouncedName.toUpperCase() === product.name) {
			setNameTaken(false);
			return;
		}
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent aria-describedby={undefined} className="sm:max-w-sm">
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Edit Product</DialogTitle>
				</DialogHeader>
