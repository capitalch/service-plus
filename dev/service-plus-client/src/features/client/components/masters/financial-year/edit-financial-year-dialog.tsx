...
export const EditFinancialYearDialog = ({ fy, onOpenChange, onSuccess, open }: EditFinancialYearDialogPropsType) => {
	...
	const submitDisabled = checkingOverlap || Object.keys(errors).length > 0 || form.formState.isSubmitting;

	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent aria-describedby={undefined} className="sm:max-w-sm">
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Edit Financial Year</DialogTitle>
				</DialogHeader>
				...
				<form className="flex flex-col gap-4 pt-1" onSubmit={form.handleSubmit(onSubmit)}>
					...
					<div className="grid grid-cols-2 gap-4">
						...
						<div className="flex flex-col gap-1.5">
							...
							<Input id="efy_start" type="date" {...form.register("start_date")} />
						...
						<div className="flex flex-col gap-1.5">
							...
							<div className="relative">
								<Input id="efy_end" type="date" {...form.register("end_date")} />
								{checkingOverlap && (
