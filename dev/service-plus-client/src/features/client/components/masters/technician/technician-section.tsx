        ...
        <>
            ...
            >
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                        <h1 className="text-xl font-bold text-(--cl-text)">Technicians</h1>
                                    ...
                                    {displayTechnicians.length === 0 ? (
                                        ...
                                        displayTechnicians.map((technician, idx) => (
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    <span className="font-mono text-xs font-semibold text-(--cl-text)">{technician.code}</span>
                                                </TableCell>
                                                <TableCell className="font-medium text-(--cl-text)">{technician.name}</TableCell>
                                                <TableCell className="text-sm text-(--cl-text-muted)">{technician.branch_name ?? "—"}</TableCell>
                                                <TableCell className="text-sm text-(--cl-text-muted)">{technician.phone ?? "—"}</TableCell>
                                                <TableCell className="text-sm text-(--cl-text-muted)">{technician.specialization ?? "—"}</TableCell>
                                                <TableCell>
                                                    <Badge
                                                        ...
                                                        variant="outline"
                                                    >
                                                        <span className={`mr-1 h-1.5 w-1.5 rounded-full ${technician.is_active ? "bg-emerald-500" : "bg-slate-400"}`} />
