                                    ...
                                    {displayBranches.length === 0 ? (
                                        ...
                                        displayBranches.map((branch, idx) => (
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    <span className="font-mono text-xs font-semibold text-(--cl-text)">{branch.code}</span>
                                                </TableCell>
                                                <TableCell className="font-medium text-(--cl-text)">{branch.name}</TableCell>
                                                ...
                                                <TableCell>
                                                    <Badge
                                                        ...
                                                        variant="outline"
                                                    >
                                                        <span className={`mr-1 h-1.5 w-1.5 rounded-full ${branch.is_active ? "bg-emerald-500" : "bg-slate-400"}`} />
