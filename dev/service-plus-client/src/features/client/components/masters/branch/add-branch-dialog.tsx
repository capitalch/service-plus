...
export const AddBranchDialog = ({ onOpenChange, onSuccess, open }: AddBranchDialogPropsType) => {
	...
	useEffect(() => {
		if (!debouncedCode || !dbName || !schema) {
			setCodeTaken(null);
			return;
		}
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			>
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Add Branch</DialogTitle>
				</DialogHeader>
				...
				<form className="flex flex-col gap-4 pt-1" onSubmit={form.handleSubmit(onSubmit)}>
					...
					<div className="grid grid-cols-2 gap-4">
						...
						<div className="flex flex-col gap-1.5">
							...
							<Input autoComplete="off" id="br_city" placeholder="City" {...form.register("city")} />
						</div>
					</div>
					...
					<div className="grid grid-cols-2 gap-4">
						...
						<div className="flex flex-col gap-1.5">
							...
							<Input autoComplete="off" id="br_pin" placeholder="Pincode" {...form.register("pincode")} />
