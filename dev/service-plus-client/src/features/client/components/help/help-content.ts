...
export const HELP_ARTICLES: HelpArticle[] = [
...

    {
        ...
        faqs: [
            ...
            { q: "Can I re-send the invoice after the job is closed and off this screen?", a: "Yes — from the Delivered Jobs grid's row actions, 'Send Invoice via WhatsApp'. See 'Sending a Money Receipt or Invoice by WhatsApp'." },
        ],
    },
...

    {
        ...
        summary: "Send a customer their payment receipt from the Receipts grid, or re-send an invoice from the Delivered Jobs grid, as a WhatsApp link rather than a printout.",
        tags: ["money receipt", "receipt", "invoice", "whatsapp", "send receipt", "send invoice", "delivered jobs", "resend", "download"],
        content: [
            ...
            { type: "heading", text: "Invoice — from Deliver Job → Delivered Jobs" },
            { type: "para", text: "Open the row actions on a delivered job and choose 'Send Invoice via WhatsApp'. The customer receives the invoice reference and a 'Download Invoice' button. The option only appears once the job actually has an invoice number." },
            ...
            { type: "heading", text: "Why the invoice send lives on Delivered Jobs" },
            { type: "para", text: "The Deliver Job screen already offers a Download Invoice button while you're handing the device over. This one exists for afterwards — a customer who lost the message, changed their number, or asks for the bill again weeks later. Delivered Jobs is the only screen that still lists a job once it's closed." },
        ...
        faqs: [
            ...
            { q: "Can I send an invoice for a job that hasn't been delivered yet?", a: "Not from here. Delivered Jobs only lists closed jobs. While you're still delivering, the Deliver Job screen's own Whatsapp Delivery message already carries a Download Invoice button." },
            { q: "The 'Send Invoice via WhatsApp' option isn't in the menu.", a: "That job has no invoice number yet — there is nothing to send. Invoices are generated as part of the delivery action." },
...

    {
        ...
        content: [
            ...
            { type: "table", headers: ["Setting", "What It Controls"], rows: [
                ...
                ["whatsapp_notifications",                 "Turns outbound WhatsApp messages on or off, one switch per event (Job Intake Message, Job Completed, Job Delivery, Money Receipt, Invoice) — see 'Turning WhatsApp messages on or off' below"],
            ]},
