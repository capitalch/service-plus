...
export const HELP_ARTICLES: HelpArticle[] = [
...

	{
		...
		content: [
			...
			{
				type: "note",
				text: "Every KPI card is clickable and opens the matching list or detail view. A card showing 0 has nothing to open, so clicking it shows a small “Nothing to show” message instead — click OK, click outside it, or press Esc to close it.",
			},
			{
				type: "note",
				text: "Open Jobs opens a two-level drill-down: first a summary of open jobs by product (with Warranty, Out-of-Warranty and Total counts per product), then clicking any count in that summary opens the actual list of jobs behind it — customer, model, technician, status and date for each one.",
			},
		],
		faqs: [
			{
