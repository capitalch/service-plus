...
export function MoneyReceiptsPostUnpostGrid({
	pendingChanges,
	onChangeToggle,
	onStatsLoaded,
	onRowsLoaded,
				...
				const [dataRes, countRes, statsRes] = await Promise.all([
					apolloClient.query<GenericQueryData<MoneyReceiptPostUnpostRow>>({
						...
						variables: {
							...
							value: graphQlUtils.buildGenericQueryValue({
								sqlId: SQL_MAP.GET_JOB_PAYMENTS_POST_UNPOST_PAGED,
					...
					apolloClient.query<GenericQueryData<{ total: number }>>({
						...
						variables: {
							...
							schema,
							value: graphQlUtils.buildGenericQueryValue({
								sqlId: SQL_MAP.GET_JOB_PAYMENTS_POST_UNPOST_COUNT,
								sqlArgs: args,
							}),
						},
					}),
					apolloClient.query<GenericQueryData<PostUnpostStats>>({
						...
						variables: {
							...
							schema,
							value: graphQlUtils.buildGenericQueryValue({
								sqlId: SQL_MAP.GET_JOB_PAYMENTS_POST_UNPOST_STATS,
								sqlArgs: args,
							}),
						},
					}),
			...
			<div className="flex flex-wrap items-center gap-2 py-2">
				<div className="relative flex-1 sm:max-w-md">
					...
					<Input
						...
						placeholder="Job no, customer, receipt, mode"
						value={search}
