...
export function SalesInvoicesPostUnpostGrid({
	pendingChanges,
	onChangeToggle,
	onStatsLoaded,
	onRowsLoaded,
				...
				const [dataRes, countRes, statsRes] = await Promise.all([
					apolloClient.query<GenericQueryData<SalesInvoicePostUnpostRow>>({
						...
						variables: {
							...
							value: graphQlUtils.buildGenericQueryValue({
								sqlId: SQL_MAP.GET_SALES_INVOICES_POST_UNPOST_PAGED,
					...
					apolloClient.query<GenericQueryData<{ total: number }>>({
						...
						variables: {
							...
							schema,
							value: graphQlUtils.buildGenericQueryValue({
								sqlId: SQL_MAP.GET_SALES_INVOICES_POST_UNPOST_COUNT,
								sqlArgs: args,
							}),
						},
					}),
					apolloClient.query<GenericQueryData<PostUnpostStats>>({
						...
						variables: {
							...
							schema,
							value: graphQlUtils.buildGenericQueryValue({
								sqlId: SQL_MAP.GET_SALES_INVOICES_POST_UNPOST_STATS,
								sqlArgs: args,
							}),
						},
					}),
