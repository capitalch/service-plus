					...
					<div className="space-y-4">
						...
						<div className="flex flex-col sm:flex-row justify-end items-start sm:items-center gap-6 rounded-xl border border-zinc-200 bg-zinc-50/30 p-5 shadow-sm">
							...
							<div className="text-right">
								<p className="mb-0.5 text-[10px] font-extrabold uppercase tracking-widest text-zinc-400">
									Difference
								</p>
								<p
									className={`font-semibold ${Math.abs(diffAmount) < 0.01 ? "text-emerald-600" : "text-amber-600"}`}
								>
									{diffAmount > 0 ? "+" : ""}
