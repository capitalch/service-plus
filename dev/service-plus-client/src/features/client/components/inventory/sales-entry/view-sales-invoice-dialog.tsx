                ...
                {loading ? (
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-x-6 gap-y-3 rounded-xl border border-zinc-200 bg-zinc-50/50 p-5 text-sm sm:grid-cols-4 shadow-sm">
                            ...
                            {detail.customer_state_code && <Field label="State Code" value={detail.customer_state_code} />}
                            {detail.remarks && (
                                <Field label="Remarks" value={detail.remarks} className="col-span-2 sm:col-span-4 border-t border-zinc-100 pt-2 mt-1" />
                            )}
                        </div>
