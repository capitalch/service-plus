				...
				<div className="flex items-center gap-3">
					...
					{!loading && parts.length > 0 && (
						<div className="flex shrink-0 items-center gap-2">
							...
							{selectedCount > 0 && (
								<Badge
									className="border-sky-200 bg-sky-100 text-sky-700 dark:border-sky-700 dark:bg-sky-900/40 dark:text-sky-300"
									variant="outline"
								>
										...
										displayParts.map((part, idx) => {
											...
											return (
												...
												>
													...
													<TableCell
														className={`text-right text-sm tabular-nums ${part.qty < 0 ? "text-red-500" : "text-(--cl-text)"}`}
													>
														{part.qty}
													</TableCell>
													<TableCell>
