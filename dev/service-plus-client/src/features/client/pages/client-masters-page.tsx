...
export const ClientMastersPage = () => {
    ...
    async function handleToggleActive(branch: BranchType) {
        ...
        try {
            ...
            toast.error(
                branch.is_active
                    ? MESSAGES.ERROR_BRANCH_UPDATE_FAILED
                    : MESSAGES.ERROR_BRANCH_UPDATE_FAILED
            );
        }
    }
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-[var(--cl-surface-3)] hover:bg-[var(--cl-surface-3)]">
                                        ...
                                        <TableHead className="text-xs font-semibold uppercase tracking-wide text-[var(--cl-text-muted)]">Head Office</TableHead>
                                ...
                                <TableBody>
                                    {branches.map((branch, idx) => (
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                <span className="font-mono text-xs font-semibold text-[var(--cl-text)]">
                                                    {branch.code}
                                                </span>
                                            </TableCell>
                                            ...
                                            <TableCell>
                                                {branch.is_head_office ? (
                                                    <Badge className="border-violet-200 bg-violet-50 text-violet-700 hover:bg-violet-50" variant="outline">
                                                        Yes
                                                    </Badge>
                                                ) : (
