			...
			>
				...
				<div className="flex flex-wrap items-start justify-between gap-3">
					<div>
						...
						<p className="mt-1 text-sm text-slate-500">Manage business units for this client.</p>
					</div>
								...
								<TableBody>
									{businessUnits.map((bu, idx) => (
										...
										>
											...
											<TableCell
												className={`font-medium ${bu.is_active ? "text-slate-900" : "text-slate-400 line-through decoration-slate-300"}`}
											>
												{bu.name}
											</TableCell>
											<TableCell>
