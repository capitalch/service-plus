...
export const CreateBuSchemaDialog = ({ bu, onOpenChange, onSuccess, open }: CreateBuSchemaDialogPropsType) => {
			...
			<DialogContent aria-describedby={undefined} className="w-full sm:max-w-[400px]">
				...
				{done && (
					<div className="flex flex-col items-center gap-4 py-6 text-center">
						...
						<p className="text-sm text-slate-500">
							Schema and seed data for <span className="font-medium">{bu.name}</span> ({bu.code}) have
