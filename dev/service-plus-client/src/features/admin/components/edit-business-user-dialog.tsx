...
export const EditBusinessUserDialog = ({ onOpenChange, onSuccess, open, user }: EditBusinessUserDialogPropsType) => {
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-md">
				<DialogHeader>
					...
					<DialogDescription>
						Update details for <span className="font-semibold text-slate-800">{user.full_name}</span>.
					</DialogDescription>
				</DialogHeader>
