...
export const CreateBusinessUnitDialog = ({ onOpenChange, onSuccess, open }: CreateBusinessUnitDialogPropsType) => {
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent aria-describedby={undefined} className="w-full sm:max-w-[440px]">
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Add Business Unit</DialogTitle>
				</DialogHeader>
				...
				{step === 3 && (
					<div className="flex flex-col items-center gap-4 py-6 text-center">
						...
						<p className="text-sm text-slate-500">
							<span className="font-medium">{createdBu?.name}</span> ({createdBu?.code}) has been created
							successfully.
						</p>
