...
export const EditBusinessUnitDialog = ({ bu, onOpenChange, onSuccess, open }: EditBusinessUnitDialogPropsType) => {
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="w-full sm:max-w-[420px]">
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Edit Business Unit</DialogTitle>
				...
				<form className="flex flex-col gap-4 pt-1" onSubmit={form.handleSubmit(onSubmit)}>
					...
					<div className="flex flex-col gap-1.5">
						<Label>Code</Label>
						<Input className="font-mono text-slate-500" disabled readOnly value={bu.code.toLowerCase()} />
