...
export const CreateBusinessUserDialog = ({ onOpenChange, onSuccess, open }: CreateBusinessUserDialogPropsType) => {
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="w-full sm:max-w-[440px]">
				<DialogHeader>
					<DialogTitle className="text-base font-semibold text-foreground">Add Business User</DialogTitle>
