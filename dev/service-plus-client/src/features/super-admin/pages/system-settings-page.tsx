			...
			>
				...
				<div className="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4">
					...
					<div className="text-sm text-amber-800">
						<span className="font-semibold">Read-only view.</span> To change these settings, modify{" "}
						<code className="rounded bg-amber-100 px-1 py-0.5 font-mono text-xs">config.py</code> (or the{" "}
						<code className="rounded bg-amber-100 px-1 py-0.5 font-mono text-xs">.env</code> file) on the
