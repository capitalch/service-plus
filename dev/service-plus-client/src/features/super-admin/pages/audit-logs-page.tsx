...
import { ActivityIcon, AlertTriangleIcon, DownloadIcon, SearchIcon, UsersIcon, ZapIcon } from "lucide-react";
								...
								<ResponsiveContainer height={180} width="100%">
									...
									>
										...
										<YAxis
											...
											width={110}
										/>
										<Tooltip contentStyle={{ fontSize: 12 }} formatter={(v: any) => [v, "Count"]} />
