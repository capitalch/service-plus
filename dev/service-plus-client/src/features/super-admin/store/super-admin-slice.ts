...
import type { ActivityLogItemType, AdminUserType, ClientType, StatsType } from "@/features/super-admin/types";
...
export const { setClients, setStats } = superAdminSlice.actions;
