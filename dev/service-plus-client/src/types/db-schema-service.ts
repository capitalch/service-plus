...
const division = {
  tableName: 'division',
  columns: ['id', 'name', 'address_line1', 'address_line2', 'city', 'state_id', 'country', 'pincode', 'phone', 'email', 'gstin', 'is_active', 'created_at', 'updated_at', 'branch_id', 'code'],
...
const job_invoice = {
  ...
  columns: ['id', 'job_id', 'invoice_no', 'invoice_date', 'supply_state_code', 'aggregate', 'cgst_amount', 'sgst_amount', 'igst_amount', 'amount', 'created_at', 'updated_at'],
