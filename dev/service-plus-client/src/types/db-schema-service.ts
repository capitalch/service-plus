...
const division = {
  tableName: 'division',
  columns: ['id', 'name', 'address_line1', 'address_line2', 'city', 'state_id', 'country', 'pincode', 'phone', 'email', 'gstin', 'is_active', 'created_at', 'updated_at', 'branch_id'],
  requiredForInsert: ['id', 'name', 'address_line1', 'state_id', 'branch_id'],
  primaryKey: 'id',
  foreignKeys: {
    state_id: { table: 'state', column: 'id', $type: null as unknown as State },
...
const sales_invoice = {
  ...
  columns: ['id', 'invoice_no', 'invoice_date', 'customer_contact_id', 'customer_name', 'customer_gstin', 'customer_state_code', 'aggregate_amount', 'cgst_amount', 'sgst_amount', 'igst_amount', 'total_tax', 'total_amount', 'remarks', 'created_at', 'updated_at', 'is_return', 'division_id'],
  requiredForInsert: ['id', 'invoice_no', 'invoice_date', 'customer_contact_id', 'customer_name', 'customer_state_code', 'aggregate_amount', 'total_tax', 'total_amount', 'division_id'],
  primaryKey: 'id',
  foreignKeys: {
    customer_contact_id: { table: 'customer_contact', column: 'id', $type: null as unknown as CustomerContact },
    division_id: { table: 'division', column: 'id', $type: null as unknown as Division },
