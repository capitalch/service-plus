...
const purchase_invoice = {
  ...
  columns: ['id', 'supplier_id', 'invoice_no', 'invoice_date', 'aggregate_amount', 'cgst_amount', 'sgst_amount', 'igst_amount', 'total_tax', 'total_amount', 'branch_id', 'remarks', 'created_at', 'updated_at', 'brand_id', 'is_return'],
  requiredForInsert: ['id', 'supplier_id', 'invoice_no', 'invoice_date', 'aggregate_amount', 'total_tax', 'total_amount', 'branch_id', 'brand_id'],
  primaryKey: 'id',
  foreignKeys: {
...
export interface StockOpeningBalanceLine {
  id: number;
...
export interface StockOpeningBalanceLineInput {
  id: number;
  stock_opening_balance_id: number;
  part_id: number;
  qty: number;
