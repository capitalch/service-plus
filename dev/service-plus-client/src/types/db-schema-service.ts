...
export interface EwCustomerInput {
  id: number;
  branch_id: number;
  full_name: string;
  mobile: string;
...
const ew_customer = {
  ...
  $type: null as unknown as EwCustomer,
  $input: null as unknown as EwCustomerInput,
} as const;

// Table ew_stage_v
export interface EwStageV {
  ew_customer_id: number | null;
...
export interface EwStageVInput {
  ew_customer_id?: number | null;
  branch_id?: number | null;
  full_name?: string | null;
  mobile?: string | null;
...
const ew_stage_v = {
  ...
  primaryKey: null,
  foreignKeys: {},
  $type: null as unknown as EwStageV,
  $input: null as unknown as EwStageVInput,
} as const;
