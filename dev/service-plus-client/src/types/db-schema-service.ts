...
const ew_lead = {
  ...
  $type: null as unknown as EwLead,
  $input: null as unknown as EwLeadInput,
} as const;

// Table ew_lead_event
export interface EwLeadEvent {
  id: number;
  ew_lead_id: number;
  event_type: string;
...
export interface EwLeadEventInput {
  id: number;
  ew_lead_id: number;
  event_type: string;
  from_state?: string | null;
...
const ew_lead_event = {
  ...
  requiredForInsert: ["id", "ew_lead_id", "event_type"],
  primaryKey: "id",
  foreignKeys: {
  ew_lead_id: {
    table: "ew_lead",
  ...
  ew_message_id: {
    table: "ew_message",
    column: "id",
    $type: null as unknown as EwMessage,
  },
  },
  $type: null as unknown as EwLeadEvent,
  $input: null as unknown as EwLeadEventInput,
} as const;

// Table ew_lead_view
export interface EwLeadView {
  id: number | null;
...
export interface EwLeadViewInput {
  id?: number | null;
  branch_id?: number | null;
  full_name?: string | null;
  mobile?: string | null;
...
const ew_lead_view = {
  ...
  primaryKey: null,
  foreignKeys: {},
  $type: null as unknown as EwLeadView,
  $input: null as unknown as EwLeadViewInput,
} as const;
...
export interface EwMessageInput {
  id: number;
  ew_lead_id: number;
  kind?: string;
  band?: string | null;
...
const ew_message = {
  ...
  requiredForInsert: ["id", "ew_lead_id"],
  primaryKey: "id",
  foreignKeys: {
  ew_lead_id: {
    table: "ew_lead",
  ...
  $type: null as unknown as EwMessage,
  $input: null as unknown as EwMessageInput,
} as const;
...
export interface JobImageDocInput {
  id: number;
  job_id: number;
  url: string;
  created_at?: Date;
...
// Table spare_part_web
export interface SparePartWeb {
  id: number;
  branch_id: number;
  part_id: number | null;
  part_name: string;
...
export interface SparePartWebInput {
  id: number;
  branch_id: number;
  part_id?: number | null;
  part_name: string;
...
const spare_part_web = {
  ...
  requiredForInsert: ["id", "branch_id", "part_name", "price"],
  primaryKey: "id",
  foreignKeys: {
  branch_id: {
    table: "branch",
  ...
  $type: null as unknown as SparePartWeb,
  $input: null as unknown as SparePartWebInput,
} as const;

// Table spare_part_web_order
export interface SparePartWebOrder {
  id: number;
  branch_id: number;
  customer_name: string;
  mobile: string;
...
export interface SparePartWebOrderInput {
  id: number;
  branch_id: number;
  customer_name: string;
  mobile: string;
...
const spare_part_web_order = {
  tableName: "spare_part_web_order",
  columns: [
  "id",
  "branch_id",
  "customer_name",
  ...
  requiredForInsert: ["id", "branch_id", "customer_name", "mobile"],
  primaryKey: "id",
  foreignKeys: {
  branch_id: {
    table: "branch",
  ...
  $type: null as unknown as SparePartWebOrder,
  $input: null as unknown as SparePartWebOrderInput,
} as const;

// Table spare_part_web_order_line
export interface SparePartWebOrderLine {
  id: number;
  spare_part_web_order_id: number;
  spare_part_web_id: number;
  qty: number;
  unit_price: number;
  line_total: number;
}
export interface SparePartWebOrderLineInput {
  id: number;
  spare_part_web_order_id: number;
  spare_part_web_id: number;
  qty: number;
...
const spare_part_web_order_line = {
  tableName: "spare_part_web_order_line",
  columns: [
  "id",
  "spare_part_web_order_id",
  "spare_part_web_id",
  "qty",
  "unit_price",
  "line_total",
  ...
  $type: null as unknown as SparePartWebOrderLine,
  $input: null as unknown as SparePartWebOrderLineInput,
} as const;
...
export interface StockLocationChangeInput {
  id: number;
  part_id: number;
  branch_id: number;
  to_location_id: number;
...
// Table stock_location_master
export interface StockLocationMaster {
  id: number;
  branch_id: number;
  name: string;
  is_active: boolean;
}
export interface StockLocationMasterInput {
  id: number;
  branch_id: number;
  name: string;
  is_active?: boolean;
...
export interface TableTypes {
  ...
  ew_lead_event: {
  select: EwLeadEvent;
  input: EwLeadEventInput;
  };
  ew_lead_view: {
  select: EwLeadView;
  input: EwLeadViewInput;
  };
  ew_message: {
  select: EwMessage;
  input: EwMessageInput;
  };
  financial_year: {
  ...
  spare_part_web: {
  select: SparePartWeb;
  input: SparePartWebInput;
  };
  spare_part_web_order: {
  select: SparePartWebOrder;
  input: SparePartWebOrderInput;
  };
  spare_part_web_order_line: {
  select: SparePartWebOrderLine;
  input: SparePartWebOrderLineInput;
  };
  state: {
  select: State;
  input: StateInput;
