...
const purchase_invoice = {
  ...
  columns: ['id', 'supplier_id', 'invoice_no', 'invoice_date', 'supplier_state_code', 'aggregate_amount', 'cgst_amount', 'sgst_amount', 'igst_amount', 'total_tax', 'total_amount', 'branch_id', 'remarks', 'created_at', 'updated_at', 'brand_id', 'is_return'],
...
// Table spare_part_location_change
export interface SparePartLocationChange {
  id: number;
  part_id: number;
  branch_id: number;
...
export interface SparePartLocationChangeInput {
  id: number;
  part_id: number;
  branch_id: number;
  to_location_id: number;
...
const spare_part_location_change = {
  tableName: 'spare_part_location_change',
  ...
  foreignKeys: {
    part_id: { table: 'spare_part_master', column: 'id', $type: null as unknown as SparePartMaster },
    branch_id: { table: 'branch', column: 'id', $type: null as unknown as Branch },
    to_location_id: { table: 'spare_part_location_master', column: 'id', $type: null as unknown as SparePartLocationMaster },
  },
  $type: null as unknown as SparePartLocationChange,
  $input: null as unknown as SparePartLocationChangeInput
} as const;
...
const stock_balance = {
  ...
  foreignKeys: {
    part_id: { table: 'spare_part_master', column: 'id', $type: null as unknown as SparePartMaster },
    branch_id: { table: 'branch', column: 'id', $type: null as unknown as Branch },
    location_id: { table: 'spare_part_location_master', column: 'id', $type: null as unknown as SparePartLocationMaster },
  },
...
export interface StockBranchTransfer {
  id: number;
  transfer_date: Date;
...
export interface StockBranchTransferLine {
  id: number;
...
export interface StockBranchTransferLineInput {
  id: number;
  stock_branch_transfer_id: number;
  part_id: number;
  qty: number;
...
export interface StockLoanLine {
  id: number;
...
export interface StockTransaction {
  ...
  stock_adjustment_line_id: number | null;
  job_part_used_id: number | null;
  stock_branch_transfer_line_id: number | null;
  stock_loan_line_id: number | null;
}
...
const stock_transaction = {
  ...
  columns: ['id', 'part_id', 'branch_id', 'stock_transaction_type_id', 'transaction_date', 'dr_cr', 'qty', 'unit_cost', 'remarks', 'created_at', 'purchase_line_id', 'sales_line_id', 'stock_adjustment_line_id', 'job_part_used_id', 'stock_branch_transfer_line_id', 'stock_loan_line_id'],
...
export interface TableTypes {
  ...
  spare_part_location_change: {
    select: SparePartLocationChange;
    input: SparePartLocationChangeInput;
  };
