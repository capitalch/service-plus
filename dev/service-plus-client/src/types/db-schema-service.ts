...
const purchase_invoice = {
  ...
  columns: ['id', 'supplier_id', 'invoice_no', 'invoice_date', 'supplier_state_code', 'aggregate_amount', 'cgst_amount', 'sgst_amount', 'igst_amount', 'total_tax', 'total_amount', 'branch_id', 'remarks', 'created_at', 'updated_at', 'brand_id'],
  requiredForInsert: ['id', 'supplier_id', 'invoice_no', 'invoice_date', 'supplier_state_code', 'aggregate_amount', 'total_tax', 'total_amount', 'branch_id', 'brand_id'],
  primaryKey: 'id',
  foreignKeys: {
...
// Table spare_part_location
export interface SparePartLocation {
  id: number;
  part_id: number;
  spare_part_location_id: number;
}
export interface SparePartLocationInput {
  id: number;
  part_id: number;
  spare_part_location_id: number;
}
const spare_part_location = {
  tableName: 'spare_part_location',
  columns: ['id', 'part_id', 'spare_part_location_id'],
  requiredForInsert: ['id', 'part_id', 'spare_part_location_id'],
  primaryKey: 'id',
  foreignKeys: {
    part_id: { table: 'spare_part_master', column: 'id', $type: null as unknown as SparePartMaster },
    spare_part_location_id: { table: 'spare_part_location_master', column: 'id', $type: null as unknown as SparePartLocationMaster },
  },
  $type: null as unknown as SparePartLocation,
  $input: null as unknown as SparePartLocationInput
} as const;

// Table spare_part_location_master
export interface SparePartLocationMaster {
  id: number;
  branch_id: number;
  location: string;
  is_active: boolean;
}
export interface SparePartLocationMasterInput {
  id: number;
  branch_id: number;
  location: string;
  is_active?: boolean;
}
const spare_part_location_master = {
  tableName: 'spare_part_location_master',
  columns: ['id', 'branch_id', 'location', 'is_active'],
  requiredForInsert: ['id', 'branch_id', 'location'],
  primaryKey: 'id',
  foreignKeys: { branch_id: { table: 'branch', column: 'id', $type: null as unknown as Branch }, },
  $type: null as unknown as SparePartLocationMaster,
  $input: null as unknown as SparePartLocationMasterInput
} as const;
...
export interface TableTypes {
  ...
  spare_part_location: {
    select: SparePartLocation;
    input: SparePartLocationInput;
  };
  spare_part_location_master: {
    select: SparePartLocationMaster;
    input: SparePartLocationMasterInput;
  };
  spare_part_master: {
