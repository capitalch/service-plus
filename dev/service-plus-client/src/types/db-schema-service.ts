...
const spare_part_web_order_line = {
	...
	columns: ["id", "spare_part_web_order_id", "spare_part_web_id", "qty", "unit_price", "line_total"],
	requiredForInsert: ["id", "spare_part_web_order_id", "spare_part_web_id", "qty", "unit_price", "line_total"],
	primaryKey: "id",
	foreignKeys: {
...
const stock_adjustment = {
	...
	requiredForInsert: ["id", "adjustment_date", "adjustment_reason", "branch_id", "brand_id"],
	primaryKey: "id",
	foreignKeys: {
		branch_id: {
			table: "branch",
...
const stock_branch_transfer = {
	...
	requiredForInsert: ["id", "transfer_date", "from_branch_id", "to_branch_id", "brand_id"],
	primaryKey: "id",
	foreignKeys: {
		from_branch_id: {
			table: "branch",
...
const stock_opening_balance = {
	...
	columns: ["id", "entry_date", "ref_no", "branch_id", "remarks", "created_at", "updated_at", "brand_id"],
