...
export const MESSAGES = {
  ...
  INFO_EW_ALERT_NOT_SENT:              'The staff WhatsApp alert was not sent for this lead. The lead itself is safe — you can resend the alert.',
  INFO_EW_DISABLED:                    'Extended warranty messaging is switched off. Turn on EXTENDED_WARRANTY under Configurations, App Settings, WhatsApp notifications.',
  ...
  CONFIRM_EW_DELETE_BODY:              'This removes the customer and their entire reminder and follow-up history. This cannot be undone.',
} as const;
