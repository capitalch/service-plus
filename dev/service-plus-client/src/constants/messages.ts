...
export const MESSAGES = {
	...
	WARN_BUSINESS_USER_BU_ROLE_ASSIGN_FAILED:
		"User was created but business unit and role could not be assigned. Use the Associate BU & Role action.",
	WARN_BUSINESS_USER_CREDENTIALS_MAIL_NOT_SENT:
		"Reset link could not be emailed. Please check the user's email address.",
	WARN_BUSINESS_USER_EMAIL_NOT_SENT:
		'Business user created, but the setup email could not be sent. Use "Reset password and mail" to resend.',
	...
	ERROR_DIVISION_CHANGE_HAS_RECEIPTS:
		"Division cannot be changed because one or more money receipts have already been issued against this job. Delete the receipts first to move the job to another division.",
	ERROR_DIVISION_FORM_INVALID:
		"Some fields need attention before this division can be saved. Check the highlighted tab.",
	...
	ERROR_RESET_TOKEN_INVALID:
		"This reset link is invalid or has expired (links are valid for 48 hours). Please request a new one.",
	...
	WARN_ADMIN_EMAIL_NOT_SENT:
		'Admin user account was created, but the password setup email could not be sent. Use "Mail the Reset Password Link" to resend.',
	...
	ERROR_CLIENT_DELETE_HAS_DB:
		"Cannot delete this client because a database is still attached. Please detach the database first using the Detach DB option, then delete the client.",
	...
	INFO_CLIENT_DB_MANUAL_DELETE_ONLY:
		"After detaching, the database will become an orphan. Orphan databases can be deleted from the Orphan Databases panel on this page.",
	...
	WARN_INITIALIZE_ADMIN_EMAIL_NOT_SENT:
		'Admin user account was created, but the password setup email could not be sent. Use "Mail the Reset Password Link" to resend.',
	...
	ERROR_DOC_SEQ_SINV_NOT_CONFIGURED:
		"Sales Invoice document sequence is not configured or has no prefix. Set it up in Settings → Document Sequence.",
	ERROR_DOC_SEQ_JOB_NOT_CONFIGURED:
		"Job Sheet document sequence is not configured or has no prefix. Set it up in Settings → Document Sequence.",
	ERROR_DOC_SEQ_SERVICE_INV_NOT_CONFIGURED:
		"Service Invoice document sequence is not configured or has no prefix. Set it up in Settings → Document Sequence.",
	ERROR_DOC_SEQ_RECEIPT_NOT_CONFIGURED:
		"Money Receipt document sequence is not configured or has no prefix. Set it up in Settings → Document Sequence.",
	...
	ERROR_PURCHASE_LINE_FIELDS_REQUIRED:
		"Please fill all mandatory line fields (Part, Qty, and HSN for taxable items).",
	...
	ERROR_PURCHASE_PHYSICAL_CHECK_FAILED:
		"Physical invoice values do not match. Please correct the mismatches before saving.",
	...
	ERROR_RECEIPT_OVERPAYMENT_FINAL:
		"Amount exceeds the outstanding due for this final job. Overpayment is not allowed.",
	...
	ERROR_FINALIZED_JOB_REGEN_INVOICE_FAILED:
	...
	PDF_RECEIPT_DISCLAIMER:
		"Received the amounts stated above on the specified dates against their respective reference numbers. Cheque receipts are subject to realization.",
	...
	// Extended Warranty
	CONFIRM_EW_DELETE_LEAD_BODY: "The lead is removed permanently. If it was a real enquiry, cancel it instead.",
	CONFIRM_EW_DELETE_LEAD_TITLE: "Delete this lead?",
	CONFIRM_EW_DISCARD_FOLLOW_UP: "Discard this follow-up? What you typed will be lost.",
	CONFIRM_EW_SEND_BODY: "Each lead gets at most one reminder per expiry window.",
	CONFIRM_EW_SEND_TITLE: "Send {count} WhatsApp reminder{plural}?",
	...
	ERROR_EW_LEAD_DELETE_FAILED: "Failed to delete the lead. Please try again.",
	ERROR_EW_LEAD_DUPLICATE: "A lead with this mobile, serial no and warranty date already exists.",
	ERROR_EW_LEAD_SAVE_FAILED: "Failed to save the lead. Please try again.",
	ERROR_EW_LEADS_LOAD_FAILED: "Failed to load warranty leads. Please try again.",
	ERROR_EW_RESEND_ALERT_FAILED: "Failed to re-send the staff alert. Please try again.",
	ERROR_EW_SEND_FAILED: "Failed to send WhatsApp reminders. Please try again.",
	ERROR_EW_SEND_SOME_FAILED: "{count} reminder{plural} failed to send. See the Messages column for the reason.",
	ERROR_EW_SETTINGS_SAVE_FAILED: "Failed to save Extended Warranty settings. Please try again.",
	ERROR_EW_TIMELINE_LOAD_FAILED: "Failed to load this lead's history. Please try again.",
	ERROR_EW_TRANSITION_FAILED: "Failed to change the lead's state. Please try again.",
	INFO_EW_ALERT_NOT_SENT: "The staff WhatsApp alert for this lead did not go out.",
	INFO_EW_DELETE_MESSAGED: "A lead that has been messaged cannot be deleted — cancel it instead.",
	INFO_EW_DISABLED:
		"Extended Warranty sending is switched off. Turn on both switches in App Settings to send reminders.",
	INFO_EW_LEAD_CHANGED: "This lead was changed by someone else. The list has been refreshed.",
	INFO_EW_LEAD_NOT_FOUND:
		"That warranty lead was not found. It may have been deleted, or it belongs to another branch.",
	INFO_EW_NOT_SENDABLE_ALREADY_SENT: "A reminder was already sent in this expiry window.",
	INFO_EW_NOT_SENDABLE_CLOSED: "This lead is closed. Reminders are not sent to closed leads.",
	INFO_EW_NOT_SENDABLE_EXPIRED: "The warranty ended more than 7 days ago.",
	INFO_EW_NOT_SENDABLE_MOBILE: "The mobile number is not a valid 10-digit number.",
	INFO_EW_NOT_SENDABLE_OPTED_OUT: "The customer has opted out of warranty reminders.",
	INFO_EW_NOT_SENDABLE_STATE: "Reminders are sent only to New Lead and Message Sent leads.",
	INFO_EW_NO_NOTIFY_CHANNEL: "New interest will only appear in the app's bell.",
	INFO_EW_SEND_SWITCH_HINT: "Also needs App Settings → extended_warranty → Enabled.",
	INFO_EW_SETTINGS_INTRO:
		"Reminder windows are fixed: 31–60, 8–30 and 0–7 days before expiry, and up to 7 days after it. Sending also needs the Extended Warranty switch in WhatsApp notifications.",
	SUCCESS_EW_ALERT_RESENT: "Staff alert sent again.",
	SUCCESS_EW_FOLLOW_UP_RECORDED: "Follow-up recorded successfully.",
	SUCCESS_EW_LEAD_DELETED: "Lead deleted successfully.",
	SUCCESS_EW_LEAD_SAVED: "Lead saved successfully.",
	SUCCESS_EW_REMINDERS_SENT: "{count} WhatsApp reminder{plural} sent.",
	SUCCESS_EW_SETTINGS_SAVED: "Extended Warranty settings saved.",
	SUCCESS_EW_STATE_CHANGED: "Lead moved to {state}.",
	WARN_EW_SEND_CAPPED: "{count} not sent — the daily send cap is reached.",
	WARN_EW_SEND_SKIPPED: "{count} skipped — no longer sendable.",
	// Extended Warranty — forms and screens
	ERROR_EW_BRAND_REQUIRED: "Please select a brand.",
	ERROR_EW_CONTACT_NUMBER_REQUIRED:
		"Required while Extended Warranty is enabled — it is printed in the customer's message.",
	ERROR_EW_DAILY_CAP_INVALID: "Enter a whole number, 0 or more.",
	ERROR_EW_NAME_REQUIRED: "Enter the customer's name (at least 2 characters).",
	ERROR_EW_NEXT_FOLLOW_UP_PAST: "The next follow-up must be in the future.",
	ERROR_EW_NEXT_FOLLOW_UP_TIME: "Enter a time for the next follow-up.",
	...
	INFO_EW_INVALID_STAFF_NUMBER: "The staff WhatsApp number in App Settings is not a valid mobile number.",
	INFO_EW_LOOKUP_FROM_CUSTOMER: "Found this number among Jobs customers — blank fields filled in.",
	INFO_EW_LOOKUP_FROM_LEAD: "Found an earlier warranty lead for this number — blank fields filled in.",
	INFO_EW_NO_LEADS: "No leads match this view.",
	INFO_EW_NO_STAFF_NUMBER: "No staff WhatsApp number is set in App Settings → extended_warranty.",
	INFO_EW_PERIODS_OVERLAP: "Periods overlap — This week includes Today, and This month includes This week.",
	// Opening Stock
...
export function getPostUnpostSelectAllConfirm(count: number, posted: boolean): { title: string; description: string } {
	return {
		...
		description: MESSAGES.CONFIRM_POST_UNPOST_SELECT_ALL_BODY.replace("{count}", String(count))
