...
export async function deleteJobFile(dbName: string, schema: string, imageId: number): Promise<void> {
...
export async function deleteJobFiles(dbName: string, schema: string, jobId: number): Promise<void> {
	await refreshIfNeeded();
...
export async function deleteSparePartWebImage(
	...
	const res = await fetch(
		`${getApiBaseUrl()}/api/images/spare-part-web/${dbName}/${schema}/${sparePartWebId}/image`,
		{
			method: "DELETE",
...
export async function reorderSparePartWebImages(
	...
	const res = await fetch(
		`${getApiBaseUrl()}/api/images/spare-part-web/${dbName}/${schema}/${sparePartWebId}/order`,
		{
			method: "PUT",
			headers: { ...getAuthHeaders(), "Content-Type": "application/json" },
...
export async function deleteSparePartWebPartImages(
	...
	const res = await fetch(
		`${getApiBaseUrl()}/api/images/spare-part-web/${dbName}/${schema}/part/${sparePartWebId}?${params}`,
		{
			method: "DELETE",
			headers: getAuthHeaders(),
		},
