...
- Allover the codebase, use red color only for errors. This is a hard rule. Do not use red color for any control css or anywhere else.
...
- Always sort the objects and types by its properties
