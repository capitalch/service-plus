...
| Entry points | Delivered Jobs grid + Finalized Jobs grid |
...
## Step 5 — Register the right against the sql_id
...
## Step 6 — Why not plain `genericUpdate`

Recorded so this is not re-litigated during implementation.

`_require_generic_update_table_right` (`mutation.py:112`) reads **only the top-level
...
## Step 9 — "needs a cost" predicate, one definition
...
## Step 12 — Wire into Delivered Jobs
...
## Step 13 — Wire into Finalized Jobs
