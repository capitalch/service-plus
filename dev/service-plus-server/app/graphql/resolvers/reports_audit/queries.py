"""Reports/audit query resolvers: admin & super-admin dashboards, audit logs,
system settings, usage health. Split from query_helper.py — see
...
from app.db.connection.psycopg_driver import exec_sql_query, exec_sql_batch_query
