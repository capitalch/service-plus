...
class SeedBuData:
    ...
    BU_SEED_SQL = """
        ...
        INSERT INTO app_setting (id, setting_key, setting_value, description, is_editable) VALUES
            ...
            (15, 'whatsapp_notifications',           '{"JOB_CREATION": false, "JOB_COMPLETION": true, "JOB_DELIVERY": false}',  'Per-event on/off switch for outbound WhatsApp messages — keys mirror job.whatsapp_notifications (JOB_CREATION/JOB_COMPLETION/JOB_DELIVERY)', true)
        ON CONFLICT (id) DO NOTHING;
    """
