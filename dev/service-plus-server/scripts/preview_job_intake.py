...
def main() -> None:
    single = _JobIntakeData(
        ...
        division_name="Cellcare Services Pvt Ltd",
        division_address="12 MG Road, Bengaluru, Karnataka, 560001",
        division_phone="080-4123 5566",
        division_email="care@cellcareservices.example",
        division_gstin="29ABCDE1234F1Z5",
        ...
        client_name="cellcare",
        track_job_url="track.cellcareservices.example",
    )
    ...
    batch = _JobIntakeData(
        ...
        division_name="Cellcare Services Pvt Ltd",
        division_address="Sector V, Salt Lake, Kolkata, West Bengal, 700091",
        ...
        items=[
            _JobIntakeItem(
                ...
                product_name="Galaxy S21", brand_name="Samsung", model_name="SM-G991B", serial_no="RZ8N40ABCDE",
            ),
            _JobIntakeItem(
                ...
                product_name="Inspiron 15", brand_name="Dell", model_name="3520", serial_no="5CD1234XYZ",
            ),
            _JobIntakeItem(
                ...
                receive_condition_name=None, warranty_card_no=None, purchase_date=None,
                product_name=None, brand_name=None, model_name=None, serial_no=None,
            ),
            _JobIntakeItem(
                ...
                product_name="Nord CE 3 Lite", brand_name="OnePlus", model_name=None, serial_no=None,
            ),
            _JobIntakeItem(
                ...
                product_name="Pavilion x360", brand_name="HP", model_name="14-dw1023", serial_no="CND9012FQR",
            ),
        ],
        client_name="cellcare",
        track_job_url="track.cellcareservices.example",
    ...
    big_batch = _JobIntakeData(
        ...
        items=[
            _JobIntakeItem(
                ...
                receive_condition_name=None, warranty_card_no=None, purchase_date=None,
                product_name=f"Product {i}", brand_name=f"Brand {i}", model_name=f"Model {i}",
