    ...
    return (
        <header className="fixed left-0 right-0 top-0 z-50 flex h-12 items-center overflow-x-auto border-b border-(--cl-border) bg-(--cl-bg) px-3 sm:px-4">
            ...
            <button
                ...
                aria-controls="client-explorer"
                aria-expanded={explorerOpen}
                aria-label={explorerOpen ? "Close navigation menu" : "Open navigation menu"}
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3 lg:gap-4 overflow-hidden">
                ...
                <button
                    ...
                    aria-controls="client-explorer"
                    aria-expanded={explorerOpen}
                    aria-label={explorerOpen ? "Close navigation panel" : "Open navigation panel"}
                ...
                <span className="shrink-0 text-xs font-bold uppercase tracking-wider text-(--cl-accent-text) md:hidden">
                    {activeSection}
                </span>
