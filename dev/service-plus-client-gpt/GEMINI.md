...
- When any text command is given and last word is plan or you are in plan mode, then do the plan only for the given command. Write your plan in the folder /plans/planA.md (In the root folder). Don't touch existing plan.md file.
