...
--
-- Name: spare_part_location; Type: TABLE; Schema: demo1; Owner: webadmin
--

CREATE TABLE demo1.spare_part_location (
    id bigint NOT NULL,
    part_id bigint NOT NULL,
    spare_part_location_id bigint NOT NULL
);


ALTER TABLE demo1.spare_part_location OWNER TO webadmin;

--
-- Name: spare_part_location_id_seq; Type: SEQUENCE; Schema: demo1; Owner: webadmin
--

ALTER TABLE demo1.spare_part_location ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME demo1.spare_part_location_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: spare_part_location spare_part_location_part_id_spare_part_location_id_key; Type: CONSTRAINT; Schema: demo1; Owner: webadmin
--

ALTER TABLE ONLY demo1.spare_part_location
    ADD CONSTRAINT spare_part_location_part_id_spare_part_location_id_key UNIQUE (part_id, spare_part_location_id);


--
-- Name: spare_part_location spare_part_location_pkey; Type: CONSTRAINT; Schema: demo1; Owner: webadmin
--

ALTER TABLE ONLY demo1.spare_part_location
    ADD CONSTRAINT spare_part_location_pkey PRIMARY KEY (id);
...
ALTER TABLE demo1.stock_transaction
    ADD CONSTRAINT stock_transaction_check CHECK ((((((((purchase_line_id IS NOT NULL))::integer + ((sales_line_id IS NOT NULL))::integer) + ((stock_adjustment_line_id IS NOT NULL))::integer) + ((job_part_used_id IS NOT NULL))::integer) + ((stock_branch_transfer_line_id IS NOT NULL))::integer) = 1)) NOT VALID;


--
-- Name: stock_transaction stock_transaction_check1; Type: CHECK CONSTRAINT; Schema: demo1; Owner: webadmin
--

ALTER TABLE demo1.stock_transaction
    ADD CONSTRAINT stock_transaction_check1 CHECK (((((((((purchase_line_id IS NOT NULL))::integer + ((sales_line_id IS NOT NULL))::integer) + ((stock_adjustment_line_id IS NOT NULL))::integer) + ((job_part_used_id IS NOT NULL))::integer) + ((stock_branch_transfer_line_id IS NOT NULL))::integer) + ((stock_loan_line_id IS NOT NULL))::integer) = 1)) NOT VALID;
...
--
-- Name: spare_part_location_part_id_idx; Type: INDEX; Schema: demo1; Owner: webadmin
--

CREATE INDEX spare_part_location_part_id_idx ON demo1.spare_part_location USING btree (part_id) WITH (deduplicate_items='true');


--
-- Name: spare_part_location_spare_part_location_id_idx; Type: INDEX; Schema: demo1; Owner: webadmin
--

CREATE INDEX spare_part_location_spare_part_location_id_idx ON demo1.spare_part_location USING btree (spare_part_location_id) WITH (deduplicate_items='true');
...
--
-- Name: spare_part_location spare_part_location_part_id_fkey; Type: FK CONSTRAINT; Schema: demo1; Owner: webadmin
--

ALTER TABLE ONLY demo1.spare_part_location
    ADD CONSTRAINT spare_part_location_part_id_fkey FOREIGN KEY (part_id) REFERENCES demo1.spare_part_master(id);


--
-- Name: spare_part_location spare_part_location_spare_part_location_id_fkey; Type: FK CONSTRAINT; Schema: demo1; Owner: webadmin
--

ALTER TABLE ONLY demo1.spare_part_location
    ADD CONSTRAINT spare_part_location_spare_part_location_id_fkey FOREIGN KEY (spare_part_location_id) REFERENCES demo1.spare_part_location_master(id);
