...
async def resolve_create_job_invoice(_, info, db_name: str = "", schema: str = "public", value: str = "") -> Any:
    try:
...
async def resolve_regenerate_job_invoice(_, info, db_name: str = "", schema: str = "public", value: str = "") -> Any:
    try:
